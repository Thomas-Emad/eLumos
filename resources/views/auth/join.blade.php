        ...
        <div id="logs">
            ...
            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="register" role="tabpanel"
                ...
                <form>
                    ...
                    <x-input-icon name='name-register' title="Your name?!" typeInput='text' class="" defValue=''
                        id="name-register" placeholder="What is Your Name?..">
                        <i class="fa-solid fa-user text-gray-500"></i>
                    </x-input-icon>
                    <x-input-icon name='email-register' title=" Your e-mail?!" typeInput='email' class=""
                        defValue='' id="email-register" placeholder="name@elumos.com?..">
                        <i class="fa-solid fa-envelope text-gray-500"></i>
                    </x-input-icon>
                    ...
                    <x-input-icon name='confirm_password' title="Your Password?!" typeInput='password' class=""
                        defValue='' id="confirm_password" placeholder="********">
