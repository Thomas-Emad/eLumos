                ...
                <div class="text-white w-full md:w-[65%]">
                    ...
                    <div class="mt-4 flex gap-4 text-sm">
                        <div class="flex gap-2 items-center">
                            <img src="{{ asset('assets/images/icons/lesson.png') }}" alt="icon lesson count"
                                class="w-5 h-5">
            ...
            <div class="w-full md:w-2/3 ">
                ...
                <div class="p-4 bg-white dark:bg-gray-700 rounded-xl border border-gray-200 mt-4">
                    <div class="flex justify-between gap-2 items-center font-bold">
                        ...
                        <div>
                            {{ $course->lectures()->count() }} Lectures 10:56:11
                        </div>
                    </div>
                            ...
                            <div
                                ...
                                <h2 id="content-course-heading-{{ $section->id }}">
                                    <button type="button"
                                        ...
                                        data-accordion-target="#content-course-body-{{ $section->id }}"
                                        aria-expanded="true" aria-controls="content-course-body-{{ $section->id }}">
                                ...
                                <div id="content-course-body-{{ $section->id }}" class="hidden"
                                    ...
                                    <div
                                        class="p-2 border border-b-0 border-gray-200 text-gray-600 dark:text-gray-100 text-sm">
                ...
                <div class="p-4 bg-white dark:bg-gray-700 rounded-xl border border-gray-200 mt-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <div>
                                <h4 class="font-bold text-xl hover:text-amber-500 duration-300">
                                    <a
                                        href="{{ route('dashboard.profile', $course->user->id) }}">{{ $course->user->name }}</a>
                                </h4>
                    ...
                    <div class="text-gray-800 dark:text-gray-200 text-sm whitespace-pre-line">
                        ...
                        Photoshop,
                        GUI, Html, Css, Grid Systems, Typography, Minimal, Template, English, Bootstrap, Responsive Web
                        Design,
                ...
                <div class="relative bg-white dark:bg-gray-700 rounded-lg shadow">
                    ...
                    <div class="px-4 pb-4 md:px-5 md:pb-5">
                        <label for="course-url"
                            class="text-sm font-medium text-gray-900 dark:text-gray-100 mb-2 block">Share
                            the
        ...
        <div id="reviews-modal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div class="relative bg-white dark:bg-gray-700 rounded-lg shadow">
                    ...
                    <!-- Modal body -->
                    <div class="p-4 md:p-5 space-y-4 ">
                        <div div id="accordion-flush" data-accordion="collapse"
                            class="border-b border-gray-100 mb-2 py-2">
                            ...
                            <div id="add_feedback-body-1" class="hidden" aria-labelledby="add_feedback-heading-1">
                                <form class="mt-2">
                                    <div
                                        class="w-full mb-4 border border-gray-200 dark:bg-gray-600 rounded-lg bg-gray-50 ">
                                ...
                                <p class="ms-auto text-xs text-gray-500 dark:text-gray-100">Remember, contributions to this
                                    topic should follow our <a href="#"
                                        class="text-blue-600  hover:underline">Community
                                        Guidelines</a>.</p>
