    ...
    <div class="container mx-auto min-h-auto-xl ">
        ...
        @session('message.error')
            <x-message id="message-error">
                ...
                <div class="ms-3 text-sm font-normal">{{ session('message.error') }}.</div>
            </x-message>
        @endsession

        @session('message.success')
            <x-message id="message-success">
                <div
                ...
                <div class="ms-3 text-sm font-normal">{{ session('message.success') }}.</div>
            </x-message>
        @endsession
                ...
                <form action="{{ route('roles.update', 'setting') }}" method="POST">
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        <div class="informaiton">
                            <x-input-icon class="" id="roleName" name="name" typeInput="text"
                                ...
                                <ul class="inline-flex -space-x-px rtl:space-x-reverse text-sm h-8">
                                    ...
                                    <li>
                                        <a href="#" aria-current="page"
                                            class="flex items-center justify-center px-3 h-8 text-amber-600 border border-gray-300 bg-amber-50 hover:bg-amber-100 hover:text-amber-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white">3</a>
                                    </li>
                                    <li>
                                        <a href="#"
