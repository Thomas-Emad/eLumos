...
@section('content')
  ...
  @if (request()->input('step') == '2')
    ...
    <x-modal id="add-lecture-modal">
      <form id="add-lecture" class="modal" enctype="multipart/form-data">
        <!-- Modal header -->
        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
          <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-50">
        ...
        <div class="p-4 md:p-5 space-y-4">
          ...
          <div>
            <div id="lecture" data-tabs-toggle="#lecture-content" role="tablist">
              <button class="inline-block py-2 px-4  rounded-xl bg-gray-100" id="video-tab" data-tabs-target="#video"
                type="button" role="tab" aria-controls="video" aria-selected="false">Video</button>
              <button class="inline-block py-2 px-4 rounded-xl border border-gray-50 hover:bg-gray-50" id="text-tab"
                data-tabs-target="#text" type="button" role="tab" aria-controls="text"
                aria-selected="false">Text</button>
              <button class="inline-block py-2 px-4 rounded-xl border border-gray-50 hover:bg-gray-50" id="exam-tab"
                ...
                <div class="flex items-center justify-center w-full my-2">
                  <label for="dropzone-file"
                    ...
                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                      ...
                      <p class="mb-2 text-sm text-gray-500 dark:text-gray-100 "><span class="font-semibold">Click to
                          upload</span> or drag and drop</p>
                      <p class="text-xs text-gray-500 dark:text-gray-100 ">Video (MAX.
                        40MB)</p>
                    </div>
                    <input id="dropzone-file" type="file" name="video" accept="video/mp4" class="hidden" />
                  </label>

                  <button class="upload-video" type="button"
                    class="bg-amber-500 hover:bg-amber-600 text-white font-bold py-2 px-4 rounded">upload video</button>
