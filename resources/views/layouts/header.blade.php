...
<div id="mega-menu-full-dropdown"
  ...
  <div class="grid max-w-screen-xl px-4 py-5 mx-auto text-gray-900 dark:text-gray-200 sm:grid-cols-2 md:px-6">
    <ul>
      ...
      <li>
        <a href="{{ route('course-details') }}" class="block p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
    ...
    <ul>
      <li>
        <a href="{{ route('privacy') }}" class="block p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
