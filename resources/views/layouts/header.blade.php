            ...
            <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <div class="flex items-center space-x-2">
                    ...
                    <i data-drawer-target="sidebar-cart" data-drawer-show="sidebar-cart" aria-controls="sidebar-cart"
                        class="btn-cart fa-solid fa-basket-shopping px-3 py-1 text-sm  border-2 border-amber-500 rounded-full text-gray-600 hover:bg-amber-500 hover:text-white cursor-pointer transition-all dark:text-gray-200"></i>
                    @if (Auth::check())
                        <div class="relative">
                            <!-- Icon -->
...
<div id="sidebar-cart"
    ...
    <div class="py-4 overflow-y-auto">
        {{-- Loader --}}
        <div class="loader-cart flex justify-center" role="status">
        ...
        <div class="cart-content flex flex-col gap-4  hidden ">
            <div class="cart">
